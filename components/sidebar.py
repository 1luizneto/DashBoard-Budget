...
layout = dbc.Col([
    ...
    dbc.Button(id='botao_avatar',
               children=[html.Img(src='/assets/img_hom.png', id='avatar_change', alt='Avatar',
        ...
        dbc.ModalBody([
            ...
            dbc.Row([
                ...
                dbc.ModalFooter([
                    ...
                    dbc.Popover(
                        dbc.PopoverBody("Receita Salva"), target="salvar_receita",
                        placement='left', trigger='click')
                ])
            ], style={'margin-top': '25px'})
        ])
    ], id='modal-novo-receita', style={'background-color': "rgba(17, 140, 79, 0.05)"},
        size="lg", is_open=False, centered=True, backdrop=True),
    ...
    dbc.Modal([
        ...
        dbc.ModalBody([
            dbc.Row([
                dbc.Col([
                    dbc.Label('Descrição: '),
                    dbc.Input(placeholder="Ex.: gasolina, cartão...", id="txt-despesa"),
                ], width=6),
                dbc.Col([
                    dbc.Label('Valor: '),
            ...
            dbc.Row([
                ...
                dbc.ModalFooter([
                    ...
                    dbc.Popover(
                        dbc.PopoverBody("Despesa Salva"), target="salvar_despesa",
                        placement='left', trigger='click')
                ])
            ], style={'margin-top': '25px'})])
    ], id='modal-novo-despesa', style={'background-color': "rgba(17, 140, 79, 0.05)"},
        size="lg", is_open=False, centered=True, backdrop=True),
